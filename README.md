...
Covid19 has affected learning and education for students around the world. 

This analysis investigates how Covid19 cases and demographics such as race, income, and computer/internet availability have impacted K-12th grade students across the United States through policies made by their school districts. The methodology included data visualization, correlation, and logistic regression. The main findings were. 

What is the impact of Covid19 on school closures and teaching methods for K-12 students across the US? How does this differ for students based on race, income, and computer/internet access?
